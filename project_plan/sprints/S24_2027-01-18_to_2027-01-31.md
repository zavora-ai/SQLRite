# S24 Plan (2027-01-18 to 2027-01-31)

Phase: Phase E - Agent-First Ecosystem
Release target: v0.9.0

## Sprint Goal
TypeScript SDK parity and cross-platform SDK CI
...
- TypeScript client, contract tests, CI matrix expansion
...
- Sprint report (project_plan/reports/S24.md) with evidence links.
