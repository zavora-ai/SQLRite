# S05 Plan (2026-04-27 to 2026-05-10)

Phase: Phase B - SQL-Native Retrieval Core
Release target: v0.6.0

## Sprint Goal
Vector index DDL and metadata catalog
...
- Index DDL implementation, schema metadata, migration scripts
...
- Sprint report (project_plan/reports/S05.md) with evidence links.
