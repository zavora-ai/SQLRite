# S06 Plan (2026-05-11 to 2026-05-24)

Phase: Phase B - SQL-Native Retrieval Core
Release target: v0.6.0

## Sprint Goal
Hybrid scoring engine and deterministic fallback behavior
...
- Hybrid scoring APIs, deterministic tie-break tests, fallback planner rules
...
- Sprint report (project_plan/reports/S06.md) with evidence links.
