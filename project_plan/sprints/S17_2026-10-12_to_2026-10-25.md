# S17 Plan (2026-10-12 to 2026-10-25)

Phase: Phase D - High Availability and Operations
Release target: v0.8.0

## Sprint Goal
Backup/restore and point-in-time recovery tooling
...
- Snapshot orchestration, restore verification, PITR operator runbook
...
- Sprint report (project_plan/reports/S17.md) with evidence links.
