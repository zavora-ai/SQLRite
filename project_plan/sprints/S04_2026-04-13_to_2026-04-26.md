# S04 Plan (2026-04-13 to 2026-04-26)

Phase: Phase B - SQL-Native Retrieval Core
Release target: v0.6.0

## Sprint Goal
SQL parser extension for vector operators and literal helpers
...
- Parser and planner updates, operator tests, SQL compatibility docs
...
- Sprint report (project_plan/reports/S04.md) with evidence links.
